(function($){var settings={inEffect:{opacity:"show"},inEffectDuration:600,stayTime:4E3,text:"",sticky:false,type:"notice",position:"top-right",closeText:"",close:null};var methods={init:function(options){if(options)$.extend(settings,options)},showToast:function(options){var localSettings={};$.extend(localSettings,settings,options);var toastWrapAll,toastItemOuter,toastItemInner,toastItemClose,toastItemImage;toastWrapAll=!$(".toast-container").length?$("<div></div>").addClass("toast-container").addClass("toast-position-"+
localSettings.position).appendTo("body"):$(".toast-container");toastItemOuter=$("<div></div>").addClass("toast-item-wrapper");toastItemInner=$("<div></div>").hide().addClass("toast-item toast-type-"+localSettings.type).appendTo(toastWrapAll).html($("<p>").append(localSettings.text)).animate(localSettings.inEffect,localSettings.inEffectDuration).wrap(toastItemOuter);toastItemClose=$("<div></div>").addClass("toast-item-close").prependTo(toastItemInner).html(localSettings.closeText).click(function(){$().toastmessage("removeToast",
