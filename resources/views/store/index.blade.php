                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            ...
                            <h2>R$ {{ $product-> price }}</h2>
                            <p>{{ $product-> name }}</p>
                            <a href="{{ Request::root() }}/product/4" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Mais detalhes</a>
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                ...
                                <a href="{{ Request::root() }}/cart/4/add" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Adicionar no carrinho</a>
                            </div>
                        </div>
                    </div>
                </div>
